...
CHECKPOINT="/media/SSD0/nayobi/Endovis/MICCAI2023/TAPIR/outputs/log/"$PRETRAIN_TASK"/TAPIR_"$TEXT_ENCODER"_just_actions/Fold2/checkpoint_best_mean.pyth"
EXP_NAME="TAPIR_"$TEXT_ENCODER"_"$PRETRAIN_TASK"_just_actions_prompts_layers"
