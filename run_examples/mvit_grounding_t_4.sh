...
EXP_NAME="TAPIR_"$TEXT_ENCODER"_"$PRETRAIN_TASK"_prompt_layers"
...
PRETRAIN_TASK="VARIS_GROUND"
CHECKPOINT="/media/SSD0/nayobi/Endovis/MICCAI2023/TAPIR/outputs/log/"$PRETRAIN_TASK"/TAPIR_"$TEXT_ENCODER"/Fold2/checkpoint_best_mean.pyth"
EXP_NAME="TAPIR_"$TEXT_ENCODER"_"$PRETRAIN_TASK"_prompt_layers_mlp"
...
PRETRAIN_TASK="VARIS_GROUND"
CHECKPOINT="/media/SSD0/nayobi/Endovis/MICCAI2023/TAPIR/outputs/log/"$PRETRAIN_TASK"/TAPIR_"$TEXT_ENCODER"/Fold2/checkpoint_best_mean.pyth"
EXP_NAME="TAPIR_"$TEXT_ENCODER"_"$PRETRAIN_TASK"_task_layers_mlp"
...
CHECKPOINT="/media/SSD0/nayobi/Endovis/MICCAI2023/TAPIR/outputs/log/RARP_FULL/TAPIR_biobert_RARP/checkpoints/checkpoint_epoch_00015.pyth" 
LANG_CHECK="/media/SSD0/nayobi/Endovis/MICCAI2023/PNG/model_final.pth"
EXP_NAME="TAPIR_"$TEXT_ENCODER"_full_pret"
