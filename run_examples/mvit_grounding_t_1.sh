...
# # PRETRAIN_TASK="PERMS_GROUND"
# # CHECKPOINT="/media/SSD0/nayobi/Endovis/MICCAI2023/TAPIR/outputs/log/"$PRETRAIN_TASK"/TAPIR_"$TEXT_ENCODER"_pretrain_3negatives/Fold2/checkpoint_best_mean.pyth"
# # EXP_NAME="TAPIR_"$PRETRAIN_TASK"_"$TEXT_ENCODER"_pretrain_3negatives_loss_per_task"
...
PRETRAIN_TASK="PERMS_GROUND"
CHECKPOINT="/media/SSD0/nayobi/Endovis/MICCAI2023/TAPIR/outputs/log/"$PRETRAIN_TASK"/TAPIR_"$TEXT_ENCODER"_pretrain_3negatives/Fold2/checkpoint_best_mean.pyth"
EXP_NAME="TAPIR_"$PRETRAIN_TASK"_"$TEXT_ENCODER"_pretrain_3negatives_per_task_layers"
...
PRETRAIN_TASK="PERMS_GROUND"
CHECKPOINT="/media/SSD0/nayobi/Endovis/MICCAI2023/TAPIR/outputs/log/"$PRETRAIN_TASK"/TAPIR_"$TEXT_ENCODER"_pretrain_3negatives/Fold2/checkpoint_best_mean.pyth"
EXP_NAME="TAPIR_"$PRETRAIN_TASK"_"$TEXT_ENCODER"_pretrain_3negatives_layers"
