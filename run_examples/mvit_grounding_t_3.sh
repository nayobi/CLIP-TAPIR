...
# # PRETRAIN_TASK="PHRASE_COMBS_GROUND"
# # CHECKPOINT="/media/SSD0/nayobi/Endovis/MICCAI2023/TAPIR/outputs/log/"$PRETRAIN_TASK"/TAPIR_"$TEXT_ENCODER"/Fold2/checkpoint_best_mean.pyth"
# # EXP_NAME="TAPIR_"$PRETRAIN_TASK"_"$TEXT_ENCODER"_loss_per_task"
...
# PRETRAIN_TASK="PHRASE_COMBS_GROUND"
# CHECKPOINT="/media/SSD0/nayobi/Endovis/MICCAI2023/TAPIR/outputs/log/"$PRETRAIN_TASK"/TAPIR_"$TEXT_ENCODER"/Fold2/checkpoint_best_mean.pyth"
# EXP_NAME="TAPIR_"$PRETRAIN_TASK"_"$TEXT_ENCODER"_per_task_layers"
...
PRETRAIN_TASK="PHRASE_COMBS_GROUND"
CHECKPOINT="/media/SSD0/nayobi/Endovis/MICCAI2023/TAPIR/outputs/log/"$PRETRAIN_TASK"/TAPIR_"$TEXT_ENCODER"/Fold2/checkpoint_best_mean.pyth"
EXP_NAME="TAPIR_"$PRETRAIN_TASK"_"$TEXT_ENCODER"_layers"
