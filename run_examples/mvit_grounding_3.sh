...
# TASK="INDEPS_GROUND" # Short term tasks "TOOLS" for the instrument detection task or "ACTIONS" for the atomic action recognition task
...
# EXP_NAME="TAPIR_"$TEXT_ENCODER"_layernorm"
...
LANG_CHECK="/media/SSD0/nayobi/Endovis/MICCAI2023/PNG/model_final.pth"
EXP_NAME="TAPIR_"$TEXT_ENCODER"_just_actions_l2"
