...
_C.TRAIN.PRETRAIN_TASK = 'single_grounding'

_C.TRAIN.NEGATIVES = 0
...
_C.MODEL.MAX_SEQUENCE_LENGTH = 67

_C.MODEL.MAX_BBOX_NUM = 5

_C.MODEL.MAX_PROMPTS = 112

_C.MODEL.TEXT_ENCODER = 'bert'

_C.MODEL.GROUND_LAYERS_PER_TASK = False

_C.MODEL.GROUND_LAYERS_TASK_LAYERS = False

_C.MODEL.GROUND_LAYERS_PROMPTS_LAYERS = False

_C.MODEL.GROUND_LOSS_PER_TASK = False

_C.MODEL.NUM_TOOLS = 7

_C.MODEL.NUM_ACTIONS = 16

_C.MODEL.L2_NORM = False

_C.MODEL.LAYER_NORM = False
